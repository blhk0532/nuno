...
export default function EventDialog({ categoryOptions = [] }: EventDialogProps) {
  const {
    locale,
    selectedEvent,
    isDialogOpen,
    ...
    if (selectedEvent) {
      try {
        ...
        form.reset({
          ...
          service_user_id: selectedEvent.service_user_id,
          booking_calendar_id: selectedEvent.booking_calendar_id,
