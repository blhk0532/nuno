  ...
  const handleDateSelect = useCallback(
    (info: any) => {
      ...
      setData((currentData) => ({
        ...
        service_user_id: info.resource?.id || sixthTechnician?.id || '',
      }));

      setIsEditMode(false);
      setShowBookingModal(true);
    },
    [setData, sixthTechnician],
  );
    ...
    <>
      {!sixthTechnician ? (
        ...
        <EventCalendar
          ...
          events={`/api/calendar/bookings?service_user_id=${sixthTechnician.id}`}
          ...
          <div className="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-lg bg-white p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex justify-between pt-4">
                <div>{isEditMode && (<button type="button" onClick={handleDelete} className="rounded-md bg-red-600 px-4 py-2 text-white hover:bg-red-700 focus:ring-2 focus:ring-red-500 focus:outline-none">Radera</button>)}</div>
