  ...
  const handleDateSelect = useCallback(
    (info: any) => {
      ...
      setData((currentData) => ({
        ...
        service_user_id: info.resource?.id || fifthTechnician?.id || '',
      }));

      setIsEditMode(false);
      setShowBookingModal(true);
    },
    [setData, fifthTechnician],
  );
    ...
    <>
      {!fifthTechnician ? (
        ...
        <EventCalendar
          ...
          events={`/api/calendar/bookings?service_user_id=${fifthTechnician.id}`}
          ...
          weekends={true}
          addButton={{ text: `Boka ${fifthTechnician.title}`, click() { setIsEditMode(false); setSelectedSlot({ start: new Date(), end: new Date(Date.now() + 60 * 60 * 1000), allDay: false }); setShowBookingModal(true); } }}
        />
      )}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="flex items-center space-x-3">
                    <select
                      ...
                      onChange={(e) => setData('booking_client_id', e.target.value)}
                      className="w-full rounded-md border border-gray-300 px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                    >
                ...
                <div>
                  ...
                  >
                    ...
                    {dropdownData.services.map((service: any) => (
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setData('booking_location_id', e.target.value)}
                    className="w-full rounded-md border border-gray-300 px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                  >
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setData('service_user_id', e.target.value)}
                    className="w-full rounded-md border border-gray-300 px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                  >
                    <option value="">Välj tekniker</option>
                    {dropdownData.serviceUsers.map((user: any) => (
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) => setData('service_note', e.target.value)}
                  rows={3}
                  className="w-full rounded-md border border-gray-300 px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                />
              </div>
              ...
              <div className="flex justify-between pt-4">
                <div>
                  {isEditMode && (
                    <button type="button" onClick={handleDelete} className="rounded-md bg-red-600 px-4 py-2 text-white hover:bg-red-700 focus:ring-2 focus:ring-red-500 focus:outline-none">Radera</button>
                  )}
                </div>
