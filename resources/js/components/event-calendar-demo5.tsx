    ...
    <>
      {!fifthTechnician ? (
        ...
        <EventCalendar
          ...
          weekends={true}
          addButton={{ text: `${fifthTechnician.title}`, click() { setIsEditMode(false); setSelectedSlot({ start: new Date(), end: new Date(Date.now() + 60 * 60 * 1000), allDay: false }); setShowBookingModal(true); } }}
        />
      )}
