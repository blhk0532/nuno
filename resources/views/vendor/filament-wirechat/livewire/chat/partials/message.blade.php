...
@class([
    'flex flex-wrap max-w-fit text-[15px] border border-[var(--wc-light-border)]/40 dark:border-[var(--wc-dark-border)]/40 rounded-xl p-2.5 flex flex-col',
    'text-white' => $belongsToAuth, // Background color for messages sent by the authenticated user
    'text-gray-900 dark:text-white bg-[var(--wc-light-secondary)] dark:bg-[var(--wc-dark-secondary)]' => !$belongsToAuth,
