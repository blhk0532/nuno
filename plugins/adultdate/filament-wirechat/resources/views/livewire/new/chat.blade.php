    ...
    <div
        ...
        <header class=" sticky top-0 bg-[var(--wc-light-primary)] dark:bg-[var(--wc-dark-primary)] z-10 py-2">
            <div class="flex justify-between items-center justify-between pb-2">
                ...
                <h3 class="text-lg font-semibold">{{__('filament-wirechat::new.chat.labels.heading') }}</h3>
            ...
            <section
                ...
                <input dusk="search_users_field" autofocus type="search" id="users-search-field"
                       ...
                       placeholder="{{__('filament-wirechat::new.chat.inputs.search.placeholder')}}"
                       class="wc-input w-full border-0 w-auto h-9 px-3 dark:bg-[var(--wc-dark-primary)] outline-hidden focus:outline-hidden bg-[var(--wc-light-primary)] rounded-lg focus:ring-0 hover:ring-0">
        ...
        <div class="relative w-full">
            ...
            {{-- New Group button --}}
            @if (auth()->user()->canCreateGroups())

                {{-- Buton to trigger opening of new grop modal --}}
                <x-filament-wirechat::actions.new-group widget="{{$this->isWidget()}}" panel="{{$this->panelId()}}">
            ...
            <span style=" color: var(--wc-brand-primary); " class="p-1 bg-[var(--wc-light-secondary)] dark:bg-[var(--wc-dark-secondary)] rounded-full ">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="   w-5 h-5">
                    ...
                    <path
                        ...
                        <p class="dark:text-white">@lang('filament-wirechat::new.chat.actions.new_group.label')</p>
                    </button>
                </x-filament-wirechat::actions.new-group>
            @endif
            ...
            <section class="my-4 grid">
                ...
                @else
                    @if (!empty($search))
                        ...
                        <span class="m-auto">@lang('filament-wirechat::new.chat.messages.empty_search_result')</span>
                    @endif
                @endif
