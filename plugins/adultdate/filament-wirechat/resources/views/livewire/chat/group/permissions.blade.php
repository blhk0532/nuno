<div class="bg-[var(--wc-light-primary)] dark:bg-[var(--wc-dark-primary)] dark:text-white min-h-screen w-full">
    <section class="flex gap-4 z-10  items-center p-5 sticky top-0 bg-[var(--wc-light-primary)] dark:bg-[var(--wc-dark-primary)] dark:text-white border-b border-[var(--wc-light-border)] dark:border-[var(--wc-dark-border)]">
        ...
        <h3 class="dark:text-white">{{__('filament-wirechat::chat.group.permissions.heading.label')}} </h3>
    </section>
    ...
    <div class="">
        <section >
            ...
            <h5 class="w-full text-start py-4 bg-[var(--wc-light-secondary)] dark:bg-[var(--wc-dark-secondary)] dark:text-white px-4">

                {{__('filament-wirechat::chat.group.permissions.labels.members_can')}}:
            </h5>
            ...
            <ul class="space-y-2">
                ...
                <li class="w-full flex  p-5">
                    ...
                    <span class="w-full text-start">
                        <h5 class="font-medium dark:text-white">{{__('filament-wirechat::chat.group.permissions.actions.edit_group_information.label')}}</h5>
                        <p class="dark:text-gray-300">@lang('filament-wirechat::chat.group.permissions.actions.edit_group_information.helper_text')</p>
                    </span>
                ...
                <li class="w-full flex items-center p-5">
                    ...
                    <span class="w-full text-start">
                        <h5 class="font-medium dark:text-white">@lang('filament-wirechat::chat.group.permissions.actions.send_messages.label')</h5>
                    </span>
                  ...
                  <li class="w-full flex items-center p-5">
                    ...
                    <span class="w-full text-start">
                        <h5 class="font-medium dark:text-white">@lang('filament-wirechat::chat.group.permissions.actions.add_other_members.label')</h5>
                    </span>
