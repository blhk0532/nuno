<div id="info-modal" class="bg-[var(--wc-light-primary)] dark:bg-[var(--wc-dark-primary)] dark:text-white h-full flex flex-col">
    ...
    <section class="flex gap-4 z-10  items-center p-5 sticky top-0 bg-[var(--wc-light-primary)] dark:bg-[var(--wc-dark-primary)] dark:text-white border-b border-[var(--wc-light-border)] dark:border-[var(--wc-dark-border)]">
        ...
        <h3>{{ __('filament-wirechat::chat.info.heading.label') }}</h3>
    </section>
    {{-- Details --}}
            ...
            <div class="flex  flex-col items-center gap-5 ">
                ...
                <div class="mx-auto items-center justify-center grid">
                    ...
                    <a href="{{ $receiver?->wirechat_profile_url }}">
                        <x-filament-wirechat::avatar :src="$wirechat_avatar_url" class=" h-32 w-32 mx-auto" />
                    </a>
                </div>
    ...
    <section class="flex flex-col justify-start w-full">
        ...
        {{-- Only show if is not group --}}
            <button wire:confirm="{{ __('filament-wirechat::chat.info.actions.delete_chat.confirmation_message') }}" wire:click="deleteChat"
                ...
                <span>{{ __('filament-wirechat::chat.info.actions.delete_chat.label') }}</span>
            </button>
