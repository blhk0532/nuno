...
[![Latest Version on Packagist](https://img.shields.io/packagist/v/adultdate/filament-queueable-bulk-actions.svg?style=flat-square)](https://packagist.org/packages/adultdate/filament-queueable-bulk-actions)
[![Total Downloads](https://img.shields.io/packagist/dt/adultdate/filament-queueable-bulk-actions.svg?style=flat-square)](https://packagist.org/packages/adultdate/filament-queueable-bulk-actions)
...
![Bulk Action Notification](https://raw.githubusercontent.com/adultdate/filament-queueable-bulk-actions/main/resources/images/notification.png)
...
![Bulk Action Notification](https://raw.githubusercontent.com/adultdate/filament-queueable-bulk-actions/main/resources/images/resource.png)
![Bulk Action Notification](https://raw.githubusercontent.com/adultdate/filament-queueable-bulk-actions/main/resources/images/view-action.png)

## Changelog

Please see [CHANGELOG](https://github.com/adultdate/filament-queueable-bulk-actions//blob/HEAD/CHANGELOG.md) for more information on what has changed recently.

## Contributing

Please see [CONTRIBUTING](https://github.com/adultdate/filament-queueable-bulk-actions//blob/HEAD/.github/CONTRIBUTING.md) for details.

## Security Vulnerabilities

Please review [our security policy](https://github.com/adultdate/filament-queueable-bulk-actions/security/policy) on how to report security vulnerabilities.

## Credits

- [Eddie Rusinskas](https://github.com/adultdate)
- [All Contributors](https://github.com/adultdate/filament-queueable-bulk-actions/graphs/contributors)

## License

The MIT License (MIT). Please see [License File](https://github.com/adultdate/filament-queueable-bulk-actions/blob/HEAD/LICENSE.md) for more information.
