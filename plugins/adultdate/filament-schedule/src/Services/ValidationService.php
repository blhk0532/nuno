...
class ValidationService
{
     ...
     */
    protected function shouldApplyNoOverlapRule(\Adultdate\Schedule\Enums\ScheduleTypes $scheduleType, array $noOverlapConfig, array $providedRules): bool
    {
     ...
     */
    protected function findCustomScheduleConflicts(\Adultdate\Schedule\Models\Schedule $schedule): array
    {
        $conflicts = [];
     ...
     */
    protected function buildConflictErrorMessage(\Adultdate\Schedule\Models\Schedule $newSchedule, array $conflicts): string
    {
