...
async function savePersonPostortData(
    ...
    try {
        ...
        const { stdout, stderr } = await execAsync(
            `cd ${projectRoot} && php artisan tinker --execute="\\App\\Models\\RatsitPostorter::create(['post_ort' => '${postOrt}', 'post_nummer' => '${postNummer}', 'personer_count' => ${personCount}, 'personer_link' => '${ratsitLink}']); echo 'Saved person postort: ${postOrt} ${postNummer}, Count: ${personCount}';"`,
        );
